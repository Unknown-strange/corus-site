...
class EquipmentForRent(Base):
    __tablename__ = "equipment_for_rent"
    ...
    daily_rate_ghs: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False)
    ...
    rental_requests: Mapped[list["RentalRequest"]] = relationship(
        "RentalRequest", back_populates="equipment"
    )
